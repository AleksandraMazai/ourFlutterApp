...
class XDBudgetGoal extends StatelessWidget {
  XDBudgetGoal({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(50.0, 128.0),
            child:
                // Adobe XD layer: 'Goal' (group)
                Stack(
              children: <Widget>[
                  ...
                  child:
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        width: 9.0,
                        height: 9.0,
                        color: const Color(0x663d3d4c),
                      ),
                    ],
                  ),
                ),
                Transform.translate(
                  offset: Offset(21.0, 15.83),
                  child:
          ...
          Transform.translate(
            ...
            child:
              ...
              children: <Widget>[
                ...
                Transform.translate(
                  offset: Offset(269.0, 1.83),
                  child:
                      // Adobe XD layer: '$50,000' (text)
                      SizedBox(
                    width: 64.0,
                    child: Text(
                      '\$50,000',
            ...
            child:
              ...
              children: <Widget>[
                ...
                Transform.translate(
                  offset: Offset(0.0, -0.17),
                  child:
                      // Adobe XD layer: 'Monthly payment' (text)
                      SizedBox(
                    width: 199.0,
                    height: 17.0,
                    child: Text(
                ...
                Transform.translate(
                  offset: Offset(278.0, 1.83),
                  child:
                      // Adobe XD layer: '$5,000' (text)
                      SizedBox(
                    width: 53.0,
                    child: Text(
                      '\$5,000',
          ...
          Transform.translate(
            offset: Offset(14.0, 536.0),
            child:
                // Adobe XD layer: 'Period' (group)
                Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(5.0, -0.17),
                  child:
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: const Color(0x2616161c),
                          border: Border.all(
                              width: 1.0, color: const Color(0x26a7a7b8)),
                        ),
                      ),
                      Transform.translate(
                        offset: Offset(94.0, 18.0),
                        child:
                            // Adobe XD layer: 'drop-down-arrow' (group)
                            Stack(
                          children: <Widget>[
                      ...
                      Transform.translate(
                        offset: Offset(30.5, 12.83),
                        child:
                            // Adobe XD layer: '7 years' (text)
                            SizedBox(
                          width: 52.0,
                          child: Text(
                            '7 years',
                ...
                Transform.translate(
                  ...
                  child:
                    ...
                    children: <Widget>[
                      ...
                      Transform.translate(
                        offset: Offset(19.0, 12.83),
                        child:
                            // Adobe XD layer: '2 months' (text)
                            SizedBox(
                          width: 72.0,
                          child: Text(
                            '2 months',
                ...
                Transform.translate(
                  ...
                  child:
                    ...
                    children: <Widget>[
                      ...
                      Transform.translate(
                        offset: Offset(39.0, 12.83),
                        child:
                            // Adobe XD layer: 'Days' (text)
                            SizedBox(
                          width: 36.0,
                          child: Text(
                            'Days',
