...
class XDPin extends StatelessWidget {
  XDPin({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(42.5, 137.83),
            child:
                // Adobe XD layer: 'Enter your PIN numbe' (text)
                SizedBox(
              width: 302.0,
              child: Text(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: const Color(0x802b2b36),
                      ),
                    ),
                    Transform.translate(
                      offset: Offset(63.33, 0.0),
                      child:
                          // Adobe XD layer: 'Oval 4 Copy' (shape)
                          Container(
                        width: 50.0,
                        height: 50.0,
                        decoration: BoxDecoration(
                    ...
                    Transform.translate(
                      offset: Offset(126.67, 0.0),
                      child:
                          // Adobe XD layer: 'Oval 4 Copy 2' (shape)
                          Container(
                        width: 50.0,
                        height: 50.0,
                        decoration: BoxDecoration(
                    ...
                    Transform.translate(
                      offset: Offset(190.0, 0.0),
                      child:
                          // Adobe XD layer: 'Oval 4 Copy 3' (shape)
                          Container(
                        width: 50.0,
                        height: 50.0,
                        decoration: BoxDecoration(
